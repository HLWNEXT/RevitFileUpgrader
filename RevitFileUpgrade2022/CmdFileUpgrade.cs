...
namespace RevitFileUpgrade
{
    ...
    public class CmdParameterManager : IExternalCommand, IRevitPlugin
    {
        ...
        public string Name => "File Upgrade";
        public string AliasName => "File Upgrade";
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            var destionationFilePath = destinationFile.Remove(versionIndex, 4).Insert(versionIndex, "2022");
